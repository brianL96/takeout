...
const App = () => {
  ...
  useEffect(() => {
   ...
   arr.push(business5);
    ...
    console.log(arr);
    //setBlocksArray([business1, business2, business3, business4, business5, business6, business7, business8, business9, business10]);

    //setBlocksArray([business1, business2, business4, business5, arr]);
    setBlocksArray([...arr]);
  ...
  function addToPastOrders(index, businessName, cartContents){
    ...
    console.log("These are the past orders:");
    //console.log(bigArray[index].pastOrders);
  ...
  function completeClientOrder(){
    ...
    if(bigArray[i].cart === undefined){
      ...
      console.log(bigArray[i].cart);
      bigArray[i].pastOrders = addToPastOrders(i, bigArray[i].cartOrderTo, bigArray[i].cart);
      bigArray[i].cart = [];
      bigArray[i].cartOrderTo = null;
      setClientArray([...bigArray]);
    }
  ...
  */
  ...
  function getAlbumItemsWithID(id){
    ...
    console.log(blocksArray[id]);
    console.log(blocksArray[id].albumItems);
