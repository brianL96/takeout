...
const NavbarLayout = ({loginUsername, activateLogout, loginType, countClientCart, getClientCart, completeClientOrder, removeItemFromClientCart}) => {
  ...
  function getHiddenCart(){
    ...
    return [
      <div className={`flex flex-row justify-end ${hideCart}`}>
        <div className={`mt-16 flex flex-col fixed h-9/10 w-1/2 min-w-100 overflow-y-auto bg-indigo-100 border border-black z-30 ${cartSlide}`}>
