...
const ClientNavbar = ({menuArray, currentFilterList, businessName}) => {
  ...
  let [businessTitle, setBusinessTitle] = useState('');
    ...
    }, [menuArray, currentFilterList, businessName]);
    ...
    function moveToSpot(e, sectionid){
      ...
      let element = document.querySelector(`#${sectionid.replaceAll(' ', '-')}`);
