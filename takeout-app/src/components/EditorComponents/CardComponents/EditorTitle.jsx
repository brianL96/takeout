...
const EditorTitle = ({turnOffDeployment, getBlockCard, editBlockCard}) => {
    ...
    function getDeployedStatusMessage(){
        if(cardDepolyed === 'null'){
            ...
            return [<h1 className='ml-2 text-green-700'>Your business card is deployed and visible to other users.</h1>];
        }
        else if(cardDepolyed === 'false'){
            return [<h1 className='ml-2 text-red-700'>Your business card is not deployed. Without a visible business card, potential customers cannot access your business.</h1>];
        }
        else{
            return [];
        }
  ...
  return (
    <>
        <div className='flex flex-row justify-center w-full h-36 mt-24'>
...
/*
<div className='w-9/10 h-1/2 pl-2'>
<h1 className='text-base text-red-500'>Edited: Click 'Deploy' Or 'Update' To Save Changes.</h1>
</div>
*/