...
const ImageSelector = ({closeImageSelector, hideImageSelector, getAlbumItems, blocksArray, setCurrentSelectedImageTitle, defaultImageHighlight}) => {
    ...
    }, [blocksArray, defaultImageHighlight]);
