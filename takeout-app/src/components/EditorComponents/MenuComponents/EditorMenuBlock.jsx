...
const EditorMenuBlock = ({getBlockMenu, editBlockMenu, turnOffMenuDeployment, setDeployedStatusMessage, editMenuSections, getBlockMenuSections, openImageSelector, currentSelectedImageTitle, setCurrentSelectedImageTitle}) => {
        ...
        <div className='flex flex-row justify-center w-full h-auto mt-10'>
            <div className='flex flex-col justify-start w-108 screen216:w-210 h-auto'>
                ...
                <div className='flex flex-col screen216:flex-row justify-start w-108 screen216:w-210 h-auto'>
                    <div className='flex flex-row justify-center w-108 screen216:w-102 h-120'>
                        <EditorMenuSection bigClientArray={bigClientArray} addNewSection={addNewSection} setCurrentSectionTitle={setCurrentSectionTitle}/>
                    </div>
                    <div className='flex flex-row justify-center w-108 h-auto'>
                        <EditorMenu bigClientArray={bigClientArray} addMenuItem={addMenuItem} editMenuItem={editMenuItem} deleteMenuItem={deleteMenuItem} currentSectionTitle={currentSectionTitle} openImageSelector={openImageSelector} currentSelectedImageTitle={currentSelectedImageTitle} setCurrentSelectedImageTitle={setCurrentSelectedImageTitle} />
                    </div>
                </div>
            </div>
        </div>
