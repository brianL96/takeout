            ...
            <div className='flex flex-col justify-start w-108 screen216:w-210 h-auto'>
                ...
                <div className='flex flex-col screen216:flex-row justify-start w-108 screen216:w-210 h-auto'>
                    ...
                    <div className='flex flex-row justify-center w-108 h-auto'>
                        <EditorMenu bigClientArray={bigClientArray} addMenuItem={addMenuItem} editMenuItem={editMenuItem} deleteMenuItem={deleteMenuItem} currentSectionTitle={currentSectionTitle} openImageSelector={openImageSelector} currentSelectedImageTitle={currentSelectedImageTitle} setCurrentSelectedImageTitle={setCurrentSelectedImageTitle} editSelectedImageTitle={editSelectedImageTitle} resetEditSelectedImageTitle={resetEditSelectedImageTitle}/>
                    </div>
                </div>
            </div>
        </div>
