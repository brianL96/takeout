...
const BusinessMenuItem = ({sectionName, name, price, description, image, index, editorOpen, expandSize, shrinkSize, editMenuArrayItem, deleteMenuArrayItem, deleteFromItemsEdited, openImageSelector, editSelectedImageTitle, resetEditSelectedImageTitle, checkPriceFormat}) => {
    ...
    function getTop(){
        ...
        if(editorOpen){
            return [
                <div key={'key-BusinessMenuItem-EditorOpen'} className='flex flex-col justify-start w-full min-h-72 h-auto'>
        ...
        if(itemImage !== undefined && itemImage !== null && itemImage !== '...'){
            return [
                <div key={'key-BusinessMenuItem-EditorClosed-ImageFound'} className='w-full min-h-44 h-auto'>
        ...
        return [
        <div key={'key-BusinessMenuItem-EditorClosed-NoImage'} className='w-full min-h-32 h-auto'>
