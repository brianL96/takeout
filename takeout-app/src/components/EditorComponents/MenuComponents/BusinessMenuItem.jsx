...
const BusinessMenuItem = ({name, price, description, image, index, editorOpen, expandSize, shrinkSize, editMenuArrayItem, deleteMenuArrayItem, deleteFromItemsEdited, openImageSelector}) => {
                    ...
                    <div className='flex flex-row justify-start w-full h-60'>
                        ...
                        <div className='flex flex-col justify-star w-full h-60'>
                            ...
                            <div className='w-full h-16 flex flex-row justify-start items-center'> 
                                <button type="button" onClick={(e) => {openImageSelector(e, itemImage)}} className='ml-2 rounded h-10 w-24 text-base bg-slate-500 text-white'>Edit Picture</button>
                    ...
                    <div className='flex flex-row justify-start h-20 w-full'>
                        ...
                        <div className="flex flex-row justify-center h-full w-1/4">
                            <div className='flex flex-col justify-around w-20'>
                                ...
                                <button type="button" value={index} onClick={(e) => {deleteFromItemsEdited(e); deleteMenuArrayItem(e);}} className="flex flex-row justify-center items-center h-8 w-full text-lg rounded-md text-white bg-red-700"><FaRegTrashAlt/></button>
                            </div>
                        </div>
                    </div>
                </div>
