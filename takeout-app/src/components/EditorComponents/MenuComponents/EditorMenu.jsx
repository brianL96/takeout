...
const EditorMenu = ({bigClientArray, addMenuItem, editMenuItem, deleteMenuItem, currentSectionTitle, openImageSelector, currentSelectedImageTitle, setCurrentSelectedImageTitle, editSelectedImageTitle, resetEditSelectedImageTitle}) => {
...
function getSectionTitle(){
  ...
  return (
    <div className='flex flex-col w-full mt-0 screen216:mt-5'>
      ...
      <div className='flex flex-row justify-center w-full mt-0 screen216:mt-5'>
        ...
        <form onSubmit={addItem} className='flex flex-col justify-start h-92 w-105 bg-indigo-200 border border-black'>
          ...
          <div className='w-full h-16 flex flex-row justify-start items-center'> 
            <button type="button" onClick={(e) => {openImageSelector(e, currentSelectedImageTitle, {sectionName: null, itemName: null,})}} className='ml-4 rounded h-11 w-26 bg-slate-500 text-white'>Add Picture</button>
      ...
      <MenuContainer currentSectionItems={currentSectionItems} currentSectionTitle={currentSectionTitle} editMenuArrayItem={editMenuArrayItem} deleteMenuArrayItem={deleteMenuArrayItem} openImageSelector={openImageSelector} editSelectedImageTitle={editSelectedImageTitle} resetEditSelectedImageTitle={resetEditSelectedImageTitle}/>
    </div>
  )
}
