...
const MenuContainer = ({bigClientArray, currentSectionTitle, editMenuItem, deleteMenuItem, openImageSelector, editSelectedImageTitle, resetEditSelectedImageTitle}) => {
    ...
    return ( 
        <div className='flex flex-row justify-center w-108 screen216:w-102 mt-6 screen216:mt-2 mb-10'>
            <div className='flex flex-col justify-start w-full'>
                <div className='flex flex-row justify-center items-center w-full h-7 bg-gray-200 my-0 border border-gray-400'>{currentSectionTitle}</div>
