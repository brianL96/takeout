...
const EditorAlbum = ({getAlbumItems, editAlbum, turnOffAlbumDeployment, setDeployedStatusMessage, editedWarning, setEditedWarningMessage}) => { 
  ...
  function getDeployedBar(){
    ...
    return (
        <div className='flex flex-row justify-start min-w-105 w-105 screen216:w-210 screen216:min-w-210 border-x border-t border-black'>
  ...
  return (
    ...
    <div className='flex flex-col justify-start w-full min-w-108 h-176 mt-12 mb-48 ml-2 screen180:ml-0'>
      ...
      <div className='flex flex-col justify-start w-full min-w-108 h-auto mt-9'>
        ...
        <div className='flex flex-row justify-center w-full min-w-108 h-12'>
          {setCardEditorBase()}
        </div>

        <div className='flex flex-row justify-center w-full min-w-108 h-64'>
          <div className='min-w-105 w-105 screen216:w-210 screen216:min-w-210 h-full'>
