...
const PastOrders = ({listOfOrders}) => {
  ...
  function formatOrderItems(itemsArray){
    ...
    itemsArray.map((x, index) => {
      arr.push(
        <div key={`key-pastOrderSmallContainer-${index}`} className='w-full h-auto min-h-12 flex flex-row justify-start items-center border-b border-gray-500'>
  ...
  function printOrders(){
    ...
    while(outerIndex < length){
      ...
      arr.push(
        <div key={`key-pastOrderBigContainer-${outerIndex}`} className='w-108 h-auto mt-5 mb-5 border border-black'>
          ...
          <div className='w-full h-auto min-h-16 flex flex-row justify-center items-center border-b border-black'>
            <div className='h-auto min-h-8 w-auto max-w-100 break-words text-wrap overflow-visible p-2 pb-3'>
  ...
  return (
    <div className='h-full overflow-y-auto w-full min-w-120 flex flex-row justify-center screen180:mt-16 mt-32'>
      <div className='flex flex-col'>
        <div className='flex flex-row justify-center items-center w-108 h-24'>
