...
const HomeCycler = ({setCurrentSection, limitNumber}) => {
  ...
  function getFormattedNumbers(){
    ...
    while(i < size){
      ...
      arr.push(<HomeCyclerNumber number={numbersDisplay[i]} selected={selected} index={i} changeSelectedIndex={changeSelectedIndex}/>);
  ...
  return (
    <div className='flex flex-row justify-center w-full h-15 mt-5'>
      <div className='flex flex-row justify-center items-center w-216 h-full'>
